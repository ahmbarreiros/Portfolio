    ...
    return (
        <section className="header-div">
            <header className="header">
                <h6 className="header-comment">
                    /* Mande uma mensagem! ahmbarreiros.cs@gmail.com */
                </h6>
                <nav className="header-nav-bar">
                    ...
                    <a
                        href="https://www.linkedin.com/in/ant%C3%B4nio-henrique-0aa9a2242/"
                        className="header-nav-bar-link"
                        target="_blank"
                    >
                        <svg
                    ...
                    <a
                        href="mailto:ahmbarreiros.cs@gmail.com"
                        className="header-nav-bar-link"
                        target="_blank"
                    >
                        <svg
